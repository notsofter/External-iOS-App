...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary <UIApplicationLaunchOptionsKey, id> *)launchOptions
{
    ...
    dispatch_once(&onceToken, ^{
        [[NSBundle bundleWithPath:@"/System/Library/PrivateFrameworks/BaseBoard.framework"] load];
        [[NSBundle bundleWithPath:@"/System/Library/PrivateFrameworks/BaseBoardUI.framework"] load];
    });
