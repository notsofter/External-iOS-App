...
#import <libgrabkernel2/partial.h>
#import <Foundation/Foundation.h>
#import <zlib.h>
#import <libgrabkernel2/partial_private.h>
...
- (NSError*)_fetchEndOfCentralDirectory {
    ...
    self->_endOfCentralDirectory = (struct zip_end_of_central_directory *)malloc(sizeof(zip_end_of_central_directory));
    ...
    if (((zip64_end_of_central_directory_locator*)data.bytes)->signature == ZIP64_END_OF_CENTRAL_DIRECTORY_LOCATOR_SIGNATURE) {
        ...
        self->_endOfCentralDirectory64 = (struct zip64_end_of_central_directory *)malloc(sizeof(zip64_end_of_central_directory));
...
- (NSError*)_fetchCentralDirectory {
    ...
    self->_centralDirectory = (struct zip_central_directory_file_header *)malloc(range.length);
